//the famous Rat In a Maze Problem using Backtracking.
...
bool solveMaze(int maze[N][N])
{
    ...
    //If the very first block is false or marked as 0, then just mark that solution not possible                
...
{
    // in case the rat reaches the last node.
