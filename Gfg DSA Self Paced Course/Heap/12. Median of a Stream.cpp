//Naive Approach : Sort the Array then find the median accordingly
...
//Time Complexity : O(nlogn) but this is not cache friendly.
...
//Efficient Solution : O(nlogn) and it is also Cache Friendly

#include<bits/stdc++.h>
using namespace std;

void printMedians(itn arr[], int n)
{
